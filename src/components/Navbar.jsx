...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-[100] px-4 md:px-6 pt-6 bg-transparent">
      <div className="mx-auto max-w-[1500px] flex items-center justify-between gap-4">
        ...
        <div className="flex-1 bg-[#F3F3F3] rounded-full shadow-[0_18px_40px_rgba(0,0,0,0.12)] border border-white/20 transition-all duration-300">
          <div className="flex items-center justify-between px-6 py-4 md:px-10">
                ...
                return (
                  <li key={link.name} className="relative">
                    <a href={link.href} className="group relative inline-flex cursor-pointer flex-col overflow-hidden pb-1">
                      {/* Original Double-Slide Animation */}
                      ...
                      {/* Original Black Underline Styling */}
            ...
            {/* Mobile Toggle - Right Aligned in Pill */}
            ...
            {/* Spacer for Desktop to balance the logo width so links stay truly center */}
            <div className="hidden lg:block w-14 h-1"></div>
          </div>
        </div>

        {/* ORIGINAL BLUE CTA - Separate Pill */}
        <div className="hidden lg:block shrink-0">
          <button className="group relative flex items-center gap-3 overflow-hidden rounded-full border border-[#235fe7] bg-[#e8f0fc] px-7 py-4 text-[11px] font-black uppercase tracking-[0.2em] text-[#2862e8] shadow-[0_8px_30px_rgba(0,0,0,0.08)] transition-all duration-300 hover:bg-white hover:text-[#2862e8] hover:border-black/20 hover:-translate-y-[1px]">
        ...
        {/* MOBILE OVERLAY (Inspired by original sidebar logic) */}
        <AnimatePresence>
          {isOpen && (
            <>
              <motion.div
              ...
              >
                ...
                <div className="flex flex-col gap-4 p-8">
                  ...
                  <div className="mt-10">
                    <button className="w-full bg-[#e8f0fc] text-[#2862e8] py-5 rounded-full font-black uppercase tracking-widest text-xs border border-[#235fe7]">
                      Get Started
                    </button>
                  </div>
                </div>
